export default () => (
  <div>
    <h2>Visualize an NLP Classifier</h2>
    <p>This is the group final project for CSE 256 at UCSD. The web app visualizes the NLP classifier (logistic regression).</p>
    <br/>
